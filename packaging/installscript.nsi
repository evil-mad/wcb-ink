...
Name "WaterColorBot for Inkscape v1.1.0"

; The file to write
OutFile "WCB-INK_110.exe"
...
BrandingText "The WaterColorBot, by Evil Mad Scientist Laboratories"
  
; Directory dialog text header::
DirText "This WaterColorBot software needs to be installed within \
...
; Descriptions
  ...
  ; Language strings
  LangString DESC_SecMain ${LANG_ENGLISH} "Installs the WaterColorBot software within Inkscape."
  LangString DESC_SecDriver ${LANG_ENGLISH} "The USB driver for the WaterColorBot."
